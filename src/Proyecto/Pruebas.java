...
public class Pruebas {
    ...
    public static void main(String[] args) {
        ...
        // Definir las producciones utilizando arreglos
        String[][] producciones = {
            {"P", "C"},          // Regla 1
            {"C", "class M"},    // Regla 2
            {"M", "I { V }"},    // Regla 3
        ...
        pila.push(0);  // Inicializar la pila con el estado 0

        System.out.println("Ingrese una cadena de símbolos terminales (sin espacios) o 'exit' para salir:");
        String input = s.nextLine().trim();

        if (!input.equals("exit")) {
            input += "$"; // Añadir el símbolo de fin de cadena al final

            // Utilizar StringTokenizer para dividir la cadena en tokens
